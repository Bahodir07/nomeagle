...
const MAP_DETAILS: Record<string, Omit<MapCountryDetails, 'code' | 'name' | 'region' | 'hookSentence'>> = {
  ...
  tr: {
    ...
    culturalHighlights: ['Turkish tea culture', 'Ottoman architecture', 'Whirling dervishes'],
    reasonToLearn: 'Bridge Eastern and Western traditions in one of the world\'s most historically rich cultures.',
    funFact: 'Turkey is the world\'s largest producer of hazelnuts, supplying about 70% of global production.',
    heroImageUrl: '/assets/icons/countries/tr.svg',
    progressPct: 0,
    masteryStars: 0,
    capitalLat: 39.9334,
    capitalLng: 32.8597,
  ...
  es: {
    ...
    culturalHighlights: ['Flamenco', 'Tapas culture', 'La Tomatina & Semana Santa'],
    reasonToLearn: 'Connect with a language spoken by 500 million people and a culture full of festivals.',
    funFact: 'Spain has the second-largest number of UNESCO World Heritage Sites in Europe.',
    heroImageUrl: '/assets/icons/countries/es.svg',
    progressPct: 0,
    masteryStars: 0,
    capitalLat: 40.4168,
    capitalLng: -3.7038,
  ...
  us: {
    ...
    culturalHighlights: ['Hollywood & pop culture', 'Jazz & blues music', 'National Parks heritage'],
    reasonToLearn: 'Explore the culture that drives global media, technology, and entertainment.',
    funFact: 'The US has no official national language at the federal level.',
    heroImageUrl: '/assets/icons/countries/us.svg',
    progressPct: 0,
    masteryStars: 0,
    capitalLat: 38.9072,
    capitalLng: -77.0369,
  ...
  cn: {
    ...
    culturalHighlights: ['Chinese New Year', 'Tea ceremony & calligraphy', 'Kung fu & martial arts'],
    reasonToLearn: 'Understand the world\'s most populous country and its 5,000 years of continuous civilization.',
    funFact: 'China invented paper, printing, gunpowder, and the compass — four inventions that changed the world.',
    heroImageUrl: '/assets/icons/countries/cn.svg',
    progressPct: 0,
    masteryStars: 0,
    capitalLat: 39.9042,
    capitalLng: 116.4074,
  ...
  ca: {
    ...
    culturalHighlights: ['Indigenous cultures', 'Ice hockey & winter traditions', 'Multicultural mosaic'],
    reasonToLearn: 'Explore one of the most diverse and welcoming nations, shaped by Indigenous roots and global immigration.',
    funFact: 'Canada has the longest coastline of any country in the world, stretching over 202,000 km.',
    heroImageUrl: '/assets/icons/countries/ca.svg',
    progressPct: 0,
    masteryStars: 0,
    capitalLat: 45.4215,
    capitalLng: -75.6972,
